...
class UserService(UserContract):
    ...
    def is_disposable_email(self, email):
        """
        Checks if the email is from a disposable email domain.
        Returns True if it's a disposable email domain, False otherwise.
        """
        disposable_domains = [
            'mailinator.com', 'yopmail.com', 'tempmail.com', 'guerrillamail.com',
            'throwawaymail.com', 'temp-mail.org', '10minutemail.com', 'trashmail.com',
            'mailnesia.com', 'sharklasers.com', 'guerrillamail.info'
        ]
